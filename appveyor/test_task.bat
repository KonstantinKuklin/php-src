...
nmake test TESTS="%OPCACHE_OPTS% -q --offline --show-all --show-slow 1000 --set-timeout 120 -g FAIL,XFAIL,BORK,WARN,LEAK,SKIP --temp-source c:\tests_tmp --temp-target c:\tests_tmp ext\zip\tests\bug77978_windows.phpt"
